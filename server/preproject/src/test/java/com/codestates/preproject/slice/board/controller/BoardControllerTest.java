...
public class BoardControllerTest{
    ...
    public void init() throws Exception {
        this.post = new BoardPostDto(1L, "커밋이 안돼요", "커밋이 안됩니다.", List.of(new BoardTagDto(1)));
    ...
    void getMembers() throws Exception{
        // postMember 하나 더 추가
        BoardPostDto post = new BoardPostDto(1L, "커밋이 안돼요", "커밋이 안됩니다.", List.of(new BoardTagDto(1)));
        String content = gson.toJson(post);
